...
var (
	...
	partitionScheme  = flag.String("partition-scheme", "bySeries", "method used for partitioning metrics (kafka-mdm-only). (byOrg|bySeries|lastNum)")
...
func main() {
	...
	if *kafkaMdmTCPAddr != "" {
		...
		o, err := kafkamdm.New(*kafkaMdmTopic, []string{*kafkaMdmTCPAddr}, *kafkaCompression, stats, *partitionScheme)
		if err != nil {
